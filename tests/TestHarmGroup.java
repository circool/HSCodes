...
public class TestHarmGroup {
    public static void main(String[] args) {
        ...
        System.out.println(demo.getSubSections().getGroup(0).getCode());
        System.out.println(demo.getSubSections().getGroup(0).getDescription());
        System.out.println(demo.getSubSections().getGroup(0).getNote());
    }
}
