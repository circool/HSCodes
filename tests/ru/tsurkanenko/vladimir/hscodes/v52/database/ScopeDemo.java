...
import ru.tsurkanenko.vladimir.hscodes.v52.database.Groups;
import ru.tsurkanenko.vladimir.hscodes.v52.database.Items;
import ru.tsurkanenko.vladimir.hscodes.v52.database.ScopeGroups;
import ru.tsurkanenko.vladimir.hscodes.v52.database.ScopeItems;
...
public class ScopeDemo{
    public static void main(String[] args) {
        ...
        System.out.println(scopeItems.startsWith("99")[0].toString());
        System.out.println(scopeItems.startsWith("99")[0].getNestlingLevel());
