package ru.tsurkanenko.vladimir.hscodes.mvc.v52;


import ru.tsurkanenko.vladimir.hscodes.database.v52.*;
 ...
 * @see ru.tsurkanenko.vladimir.hscodes.mvc.combobox.Controller
 * @author Vladimir Tsurkanenko
 * @version 0.5.2
 * @since 0.5.1
 */
public class Model_v52 {
    ...
    public String getGroupNote() {
        return sG2.startsWith(groupList[selectedGroup].substring(0,2))[0].getPrim();
    }
    /**
    ...
    public String getSectionNote() {
        return sG1.startsWith(sectionList[selectedSection].substring(0,2))[0].getPrim();
                //hs.getRazdel(selectedSection).getPrim();
    }
    /**
    ...
    public String getDescription() {
        ...
        return sG1.startsWith(sectionList[selectedSection].substring(0,2))[0].getNaim() + "\n\t" +
                sG2.startsWith(groupList[selectedGroup].substring(0,2))[0].getNaim() + "\n\t\t" +
                sI3.startsWith(positionList[selectedPosition].substring(0,2))[0].getNaim() + "\n\t\t\t" +
