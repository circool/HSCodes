...
public class ModelForComboBox {
    ...
    public void setSectionNote() {
        //this.sectionNote = hs.getSections().getArray(selectedSection)[0].      //getSection().getNote(sectionList[selectedSection].substring(0,2))[0];
    }
    ...
    public void setGroupNote() {
        //this.groupNote = hs.getGroups().getNote(groupList[selectedGroup].substring(0,4))[0];
    }
